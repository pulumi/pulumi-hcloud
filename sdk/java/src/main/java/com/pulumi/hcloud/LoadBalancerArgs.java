...
public final class LoadBalancerArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The location name of the Load Balancer. Require when no networkZone is set. See the [Hetzner Docs](https://docs.hetzner.com/cloud/general/locations/#what-locations-are-there) for more details about locations.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param location The location name of the Load Balancer. Require when no networkZone is set. See the [Hetzner Docs](https://docs.hetzner.com/cloud/general/locations/#what-locations-are-there) for more details about locations.
         * 
         * @return builder
         * 
         */

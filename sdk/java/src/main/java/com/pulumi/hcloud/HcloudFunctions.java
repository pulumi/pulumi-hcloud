...
public final class HcloudFunctions {
     ...
     *         final var sampleCertificate1 = Output.of(HcloudFunctions.getCertificate(GetCertificateArgs.builder()
     *             .name(&#34;sample-certificate-1&#34;)
     *             .build()));
     * 
     *         final var sampleCertificate2 = Output.of(HcloudFunctions.getCertificate(GetCertificateArgs.builder()
     *             .id(&#34;4711&#34;)
     *             .build()));
     * 
     *     }
     ...
     * 
     *     public static void stack(Context ctx) {
     *         final var sampleCertificate1 = Output.of(HcloudFunctions.getCertificates(GetCertificatesArgs.builder()
     ...
     * 
     *     public static void stack(Context ctx) {
     *         final var ds1 = Output.of(HcloudFunctions.getDatacenter(GetDatacenterArgs.builder()
     *             .name(&#34;fsn1-dc8&#34;)
     *             .build()));
     * 
     *         final var ds2 = Output.of(HcloudFunctions.getDatacenter(GetDatacenterArgs.builder()
     *             .id(4)
     *             .build()));
     * 
     *     }
     ...
     * 
     *     public static void stack(Context ctx) {
     *         final var sampleFirewall1 = Output.of(HcloudFunctions.getFirewall(GetFirewallArgs.builder()
     *             .name(&#34;sample-firewall-1&#34;)
     *             .build()));
     * 
     *         final var sampleFirewall2 = Output.of(HcloudFunctions.getFirewall(GetFirewallArgs.builder()
     *             .id(&#34;4711&#34;)
     *             .build()));
     * 
     *     }
     ...
     * 
     *     public static void stack(Context ctx) {
     *         final var sampleFirewall1 = Output.of(HcloudFunctions.getFirewalls(GetFirewallsArgs.builder()
     *             .withSelector(&#34;key=value&#34;)
     *             .build()));
     * 
     *     }
     ...
     * 
     *     public static void stack(Context ctx) {
     *         final var ip1 = Output.of(HcloudFunctions.getFloatingIp(GetFloatingIpArgs.builder()
     *             .ipAddress(&#34;1.2.3.4&#34;)
     *             .build()));
     * 
     *         final var ip2 = Output.of(HcloudFunctions.getFloatingIp(GetFloatingIpArgs.builder()
     *             .withSelector(&#34;key=value&#34;)
     *             .build()));
     * 
     ...
     * 
     *     public static void stack(Context ctx) {
     *         final var ip2 = Output.of(HcloudFunctions.getFloatingIps(GetFloatingIpsArgs.builder()
     *             .withSelector(&#34;key=value&#34;)
     *             .build()));
     * 
     *     }
     ...
     * 
     *     public static void stack(Context ctx) {
     *         final var image2 = Output.of(HcloudFunctions.getImages());
     * 
     *         final var image3 = Output.of(HcloudFunctions.getImages(GetImagesArgs.builder()
     *             .withSelector(&#34;key=value&#34;)
     *             .build()));
     * 
     *     }
     ...
     * 
     *     public static void stack(Context ctx) {
     *         final var lb1 = Output.of(HcloudFunctions.getLoadBalancer(GetLoadBalancerArgs.builder()
     *             .name(&#34;my-load-balancer&#34;)
     *             .build()));
     * 
     *         final var lb2 = Output.of(HcloudFunctions.getLoadBalancer(GetLoadBalancerArgs.builder()
     *             .id(&#34;123&#34;)
     *             .build()));
     * 
     *         final var lb3 = Output.of(HcloudFunctions.getLoadBalancer(GetLoadBalancerArgs.builder()
     *             .withSelector(&#34;key=value&#34;)
     *             .build()));
     * 
     *     }
     ...
     * 
     *     public static void stack(Context ctx) {
     *         final var lb2 = Output.of(HcloudFunctions.getLoadBalancers());
     * 
     *         final var lb3 = Output.of(HcloudFunctions.getLoadBalancers(GetLoadBalancersArgs.builder()
     *             .withSelector(&#34;key=value&#34;)
     *             .build()));
     * 
     *     }
     ...
     * 
     *     public static void stack(Context ctx) {
     *         final var l1 = Output.of(HcloudFunctions.getLocation(GetLocationArgs.builder()
     *             .name(&#34;fsn1&#34;)
     *             .build()));
     * 
     *         final var l2 = Output.of(HcloudFunctions.getLocation(GetLocationArgs.builder()
     *             .id(1)
     *             .build()));
     * 
     *     }
     ...
     * 
     *     public static void stack(Context ctx) {
     *         final var network1 = Output.of(HcloudFunctions.getNetwork(GetNetworkArgs.builder()
     *             .id(&#34;1234&#34;)
     *             .build()));
     * 
     *         final var network2 = Output.of(HcloudFunctions.getNetwork(GetNetworkArgs.builder()
     *             .name(&#34;my-network&#34;)
     *             .build()));
     * 
     *         final var network3 = Output.of(HcloudFunctions.getNetwork(GetNetworkArgs.builder()
     *             .withSelector(&#34;key=value&#34;)
     *             .build()));
     * 
     *     }
     ...
     * 
     *     public static void stack(Context ctx) {
     *         final var network2 = Output.of(HcloudFunctions.getNetwork());
     * 
     *         final var network3 = Output.of(HcloudFunctions.getNetwork(GetNetworkArgs.builder()
     *             .withSelector(&#34;key=value&#34;)
     *             .build()));
     ...
     * 
     *     public static void stack(Context ctx) {
     *         final var samplePlacementGroup1 = Output.of(HcloudFunctions.getPlacementGroup(GetPlacementGroupArgs.builder()
     *             .name(&#34;sample-placement-group-1&#34;)
     *             .build()));
     * 
     *         final var samplePlacementGroup2 = Output.of(HcloudFunctions.getPlacementGroup(GetPlacementGroupArgs.builder()
     *             .id(&#34;4711&#34;)
     *             .build()));
     * 
     *     }
     ...
     * 
     *     public static void stack(Context ctx) {
     *         final var samplePlacementGroup1 = Output.of(HcloudFunctions.getPlacementGroups());
     * 
     *         final var samplePlacementGroup2 = Output.of(HcloudFunctions.getPlacementGroups(GetPlacementGroupsArgs.builder()
     *             .withSelector(&#34;key=value&#34;)
     *             .build()));
     * 
     *     }
     ...
     * 
     *     public static void stack(Context ctx) {
     *         final var ip1 = Output.of(HcloudFunctions.getPrimaryIp(GetPrimaryIpArgs.builder()
     *             .ipAddress(&#34;1.2.3.4&#34;)
     *             .build()));
     * 
     *         final var ip2 = Output.of(HcloudFunctions.getPrimaryIp(GetPrimaryIpArgs.builder()
     *             .name(&#34;primary_ip_1&#34;)
     *             .build()));
     * 
     *         final var ip3 = Output.of(HcloudFunctions.getPrimaryIp(GetPrimaryIpArgs.builder()
     *             .withSelector(&#34;key=value&#34;)
     *             .build()));
     * 
     ...
     * 
     *     public static void stack(Context ctx) {
     *         final var ip2 = Output.of(HcloudFunctions.getPrimaryIps(GetPrimaryIpsArgs.builder()
     *             .withSelector(&#34;key=value&#34;)
     *             .build()));
     * 
     *     }
     ...
     * 
     *     public static void stack(Context ctx) {
     *         final var s1 = Output.of(HcloudFunctions.getServer(GetServerArgs.builder()
     *             .name(&#34;my-server&#34;)
     *             .build()));
     * 
     *         final var s2 = Output.of(HcloudFunctions.getServer(GetServerArgs.builder()
     *             .id(&#34;123&#34;)
     *             .build()));
     * 
     *         final var s3 = Output.of(HcloudFunctions.getServer(GetServerArgs.builder()
     *             .withSelector(&#34;key=value&#34;)
     *             .build()));
     * 
     *     }
     ...
     * 
     *     public static void stack(Context ctx) {
     *         final var ds1 = Output.of(HcloudFunctions.getServerType(GetServerTypeArgs.builder()
     *             .name(&#34;cx11&#34;)
     *             .build()));
     * 
     *         final var ds2 = Output.of(HcloudFunctions.getServerType(GetServerTypeArgs.builder()
     *             .id(1)
     *             .build()));
     * 
     *     }
     ...
     * 
     *     public static void stack(Context ctx) {
     *         final var s3 = Output.of(HcloudFunctions.getServers(GetServersArgs.builder()
     *             .withSelector(&#34;key=value&#34;)
     *             .build()));
     * 
     *     }
     ...
     * 
     *     public static void stack(Context ctx) {
     *         final var sshKey1 = Output.of(HcloudFunctions.getSshKey(GetSshKeyArgs.builder()
     *             .id(&#34;1234&#34;)
     *             .build()));
     * 
     *         final var sshKey2 = Output.of(HcloudFunctions.getSshKey(GetSshKeyArgs.builder()
     *             .name(&#34;my-ssh-key&#34;)
     *             .build()));
     * 
     *         final var sshKey3 = Output.of(HcloudFunctions.getSshKey(GetSshKeyArgs.builder()
     *             .fingerprint(&#34;43:51:43:a1:b5:fc:8b:b7:0a:3a:a9:b1:0f:66:73:a8&#34;)
     *             .build()));
     * 
     *         final var sshKey4 = Output.of(HcloudFunctions.getSshKey(GetSshKeyArgs.builder()
     *             .withSelector(&#34;key=value&#34;)
     *             .build()));
     * 
     *         var main = new Server(&#34;main&#34;, ServerArgs.builder()        
     ...
     * 
     *     public static void stack(Context ctx) {
     *         final var allKeys = Output.of(HcloudFunctions.getSshKeys());
     * 
     *         final var keysBySelector = Output.of(HcloudFunctions.getSshKeys(GetSshKeysArgs.builder()
     *             .withSelector(&#34;foo=bar&#34;)
     *             .build()));
     * 
     *         var main = new Server(&#34;main&#34;, ServerArgs.builder()        
     *             .sshKeys(allKeys.apply(getSshKeysResult -&gt; getSshKeysResult.sshKeys()).stream().map(element -&gt; element.name()).collect(toList()))
     *             .build());
     * 
     *     }
     * }
     ...
     * 
     *     public static void stack(Context ctx) {
     *         final var volume_ = Output.of(HcloudFunctions.getVolumes());
     * 
     *         final var volume3 = Output.of(HcloudFunctions.getVolumes(GetVolumesArgs.builder()
     *             .withSelector(&#34;key=value&#34;)
     *             .build()));
     * 
     *     }

...
public final class VolumeState extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="linuxDevice")
    private @Nullable Output<String> linuxDevice;

    /**
     * @return (string) Device path on the file system for the Volume.
     * 
     */
    public Optional<Output<String>> linuxDevice() {
        return Optional.ofNullable(this.linuxDevice);
    }
    ...
    /**
     * @return The location name of the volume to create, not allowed if serverId argument is passed. See the [Hetzner Docs](https://docs.hetzner.com/cloud/general/locations/#what-locations-are-there) for more details about locations.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param linuxDevice (string) Device path on the file system for the Volume.
         * 
         * @return builder
         * 
         */
        public Builder linuxDevice(@Nullable Output<String> linuxDevice) {
        ...
        public Builder linuxDevice(String linuxDevice) {
            return linuxDevice(Output.of(linuxDevice));
        }

        /**
         * @param location The location name of the volume to create, not allowed if serverId argument is passed. See the [Hetzner Docs](https://docs.hetzner.com/cloud/general/locations/#what-locations-are-there) for more details about locations.
         * 
         * @return builder
         * 
         */

...
def get_floating_ips(with_selector: Optional[_builtins.str] = None,
...
def get_floating_ips_output(with_selector: Optional[pulumi.Input[Optional[_builtins.str]]] = None,

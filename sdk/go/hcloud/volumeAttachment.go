...
// Automount the volume upon attaching it.
func (o VolumeAttachmentOutput) Automount() pulumi.BoolOutput {
	return o.ApplyT(func(v *VolumeAttachment) pulumi.BoolOutput { return v.Automount }).(pulumi.BoolOutput)
}

// Server to attach the Volume to.
func (o VolumeAttachmentOutput) ServerId() pulumi.IntOutput {
	return o.ApplyT(func(v *VolumeAttachment) pulumi.IntOutput { return v.ServerId }).(pulumi.IntOutput)
}

// ID of the Volume.
func (o VolumeAttachmentOutput) VolumeId() pulumi.IntOutput {
	return o.ApplyT(func(v *VolumeAttachment) pulumi.IntOutput { return v.VolumeId }).(pulumi.IntOutput)
}

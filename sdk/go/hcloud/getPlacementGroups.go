...
func (o GetPlacementGroupsResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetPlacementGroupsResult] {
	return pulumix.Output[GetPlacementGroupsResult]{

...
// Whether delete protection is enabled.
func (o PrimaryIpOutput) DeleteProtection() pulumi.BoolOutput {
	return o.ApplyT(func(v *PrimaryIp) pulumi.BoolOutput { return v.DeleteProtection }).(pulumi.BoolOutput)
}

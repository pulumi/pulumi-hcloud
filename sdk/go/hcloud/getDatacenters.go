...
//
// > The `getDatacenters` data source is deprecated, and will be removed after 1 Oct. 2026.
// After this date, requests to the datacenters API endpoints will return `HTTP 410 Gone`.
// Please use the `getLocations` data source instead.
...
func GetDatacentersOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetDatacentersResultOutput {
	...
	return ctx.InvokeOutput("hcloud:index/getDatacenters:getDatacenters", nil, GetDatacentersResultOutput{}, options).(GetDatacentersResultOutput)
}
